...
func (repository apmConditionRepository) saveConditions(ctx context.Context, policy *domain.AlertPolicy) error {
	sp, ctx := opentracing.StartSpanFromContext(ctx, "save-apm-alert-conditions-newrelic")
	defer sp.Finish()
